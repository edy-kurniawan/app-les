    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Daftar</h2>
          <h3>Daftarkan Sebagai <span>Murid</span></h3>
        </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="<?php echo site_url('user/register/add_murid'); ?>" enctype="multipart/form-data" method="post" role="form">
              <div class="form-row">
              ...
              <div class="form-group">
                    <label for="customFile" id="label-photo">Upload kartu Pelajar</label>
