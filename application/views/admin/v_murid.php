...
<script src="<?php echo base_url('assets/js/page/modules-datatables.js') ?>"></script> 
 ...
 <!-- General JS Scripts -->
  ...
  <script type="text/javascript">
        ...
        var save_method;
         ...
         $(document).ready(function() {
          table = $('#table').DataTable({  
            "processing": true, 
            "ajax": {
                "url": "<?php echo base_url('admin/murid/setView'); ?>",
                "type": "POST",
            },
            "columns": [
    ...
    $('.modal-title').text('Input Data Murid'); // Set Title to Bootstrap modal title
    }
    ...
    $.ajax({
        url : "<?php echo site_url('admin/murid/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    if(save_method == 'add') {
    url = "<?php echo base_url('admin/murid/ajax_add')?>";
    } else {
    url = "<?php echo base_url('admin/murid/ajax_update')?>";
    }
    ...
    $.ajax({
    url : "<?php echo base_url('admin/murid/ajax_delete')?>/" +id,
    type: "POST",
    dataType: "JSON",
    success: function(data)
    {
